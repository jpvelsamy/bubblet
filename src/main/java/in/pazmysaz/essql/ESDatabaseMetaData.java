...
import in.pazmysaz.essql.jdbc.ESDriver;
...
public class ESDatabaseMetaData implements DatabaseMetaData{
	...
	public ResultSet getSchemas() throws SQLException {
		...
		SortedMap<String, IndexAbstraction> aliasAndIndices = client.admin().cluster().prepareState().get().getState()
    		.getMetadata().getIndicesLookup();
